...
routes['POST']['/addnew/create'] = 'Products#create'
routes['/addnew'] = 'Products#new_prod'
routes['/show/<id>']= 'Products#show_prod'
routes['/edit/<id>'] ='Products#edit_prod'
routes['POST']['/delete/<id>'] = 'Products#delete'
